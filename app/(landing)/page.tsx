                ...
                <div className="relative top-0 left-0 h-full">
                    <div className="flex flex-col gap-12 h-screen py-24 px-4 justify-between sticky top-0 z-10">
                        <section id={"introduction"}>
                            ...
                            <SlideFromLeftComponet ><h1 className={"text-4xl font-bold mb-2"}>Jonathan Alphabert Sutanto</h1></SlideFromLeftComponet>
                            <SlideFromLeftComponet ><p className={"text-2xl text-white mb-2"}>Fullstack Developer</p></SlideFromLeftComponet>
                        </section>
