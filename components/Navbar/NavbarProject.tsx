...
export default function Navbar() {
    ...
    return (
        <>
            <div className={`justify-between items-center px-4 py-6 z-20 w-screen ${openMenu ? "hidden" : "flex"} container mx-auto`}>
            ...
            <div className={`h-screen bg-gray-950 w-screen mx-0 ${openMenu ? "translate-x-0" : "-translate-x-full"} fixed top-0 right-0 z-50 transition-all duration-500`}>
                <div className={`flex-col gap-12 h-screen py-24 px-4 justify-between sticky top-0 z-10 flex container mx-auto `}>
